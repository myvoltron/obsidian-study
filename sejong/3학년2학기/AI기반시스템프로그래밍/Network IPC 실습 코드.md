...
# `ai_helper_chat_stream_socket.c`
```c
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
# `ai_helper_chat_stream_multiuser.c`
```c
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void)
{
    ...
    while (1) {
        ...
        // poll() 호출. 블로킹 모드. 
        int nready = poll(pollfds, MAX_CLIENTS, -1);
        if (nready < 0) {
        ...
        // --------------------------------------------------------------        
        if (pollfds[0].fd == sfd && (pollfds[0].revents & POLLIN)) {

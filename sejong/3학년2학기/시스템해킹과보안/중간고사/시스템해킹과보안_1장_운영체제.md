...
>> - Local Procedure Call Manager: IPC
>> - Virtual Memory Manager: 메모리를 할당하고 가상 메모리의 페이징 관리
>> - Graphics Device Interface Manager: 화면에 선과 곡선을 그리고 폰트를 제어함.
>> - Others: Cache manager, PNP(Plug and Play) manager, Power manager, etc.
>> ## Windows 파일 시스템
>> - FAT - 파티션 하나의 최대 크기는 2GB, FAT 테이블의 기본 크기는 16bit, 클러스터 하나는 32KB, 전체 용량은 2GB
...
>> 	- MBR에서 부트 코드 실행해서 부팅 파티션을 찾고 부트 섹터를 호출

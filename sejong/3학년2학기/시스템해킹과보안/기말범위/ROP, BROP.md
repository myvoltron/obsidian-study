...
## 1.1 ROP 개요 및 정의
- 실제 함수 대신, 프로그램의 **메모리 공간에 존재**하는 **gadget**을 활용해 임의의 동작 수행
- **이미 존재하는 gadget**을 이용하기 때문에, ASLR이나 NXbit 같은 **보안이 활성화**된 상태에서 코드를 실행할 수 있게 함
...
- 덤프된 바이너리를 분석하여 `puts` 함수의 GOT 주소를 찾음
### 2.2.7 libc 주소 유출
...
- ![[Pasted image 20251209165645.png|600]]
# 3. 관련 개념 및 용어
...
![[Pasted image 20251209165958.png]]
